...
const TodoHeader = (props: TodoHeaderProps) => {
  ...
  return (
    <>
      <div className="border-2 p-1 rounded-md w-52 h-56 my-10 md:w-40 bg-gray-100 m-auto">
        <h2 className=" text-center bg-[#BBE2EC] py-1 rounded-md mb-3">TO DO</h2>
        <ul>
          {todoList.map((todo, index) => (
            <li key={index} className="text-sm my-1 flex items-center">
